...
function rishi_scripts()
{
    ...
    wp_enqueue_style( 'rishi-gutenberg', get_template_directory_uri(). '/css/build/gutenberg.min.css', array(), RISHI_VERSION );
 ...
 */
if ( defined( 'THEME_CUSTOMIZER_BUILDER_DIR__' ) && ! ! THEME_CUSTOMIZER_BUILDER_DIR__ ) {
