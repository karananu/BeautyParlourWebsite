...
function rishi__cb_customizer_get_frontend_selector_for_prefix( $prefix = '' ) {
	...
	if ( $prefix === 'woo_categories' ) {
		return array( 'body.post-type-archive-product', 'body.woocommerce-archive' );
	}
...
function rishi__cb_customizer_sync_single_post_thumbnail( $args = array() ) {
...
function rishi__cb_customizer_replace_current_template() {
	$tag_templates = array(
	...
	if (
		...
		echo '<main ' . rishi__cb_customizer_main_attr() . '>';

		// rishi__cb_customizer_before_current_template();
		get_template_part( 'template-parts/single' );
		// rishi__cb_customizer_after_current_template();
