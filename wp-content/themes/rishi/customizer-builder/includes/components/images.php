...
if (!function_exists('rishi__cb_customizer_image')) {
	function rishi__cb_customizer_image( $args = [] )
	{
		...
		$a_tag_start = ( ( is_archive() || is_home() || is_search() ) && function_exists('is_shop') && !is_shop() )  ? '<a href="' . esc_url( get_the_permalink() ) . '">' : '';
		$a_tag_end   = ( ( is_archive() || is_home() || is_search() ) && function_exists('is_shop') && !is_shop() ) ? '</a>' : '';
...
if (!function_exists('rishi__cb_customizer_get_all_wp_image_sizes')) {
	function rishi__cb_customizer_get_all_wp_image_sizes(  )
	{
		...
		// rishi__cb_customizer_print($image_sizes);
