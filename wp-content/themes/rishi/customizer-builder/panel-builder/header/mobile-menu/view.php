...
$menu = rishi__cb_customizer_default_akg( 'menu', $atts, 'rishi__cb_customizer_location' );

if ( $menu === 'rishi__cb_customizer_location' ) {
} else {
	$menu_args['menu'] = $menu;
}
...
wp_nav_menu(
	$menu === 'rishi__cb_customizer_location' ? array(
		'container'                   => false,
		'menu_class'                  => false,
