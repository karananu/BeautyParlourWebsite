...
<a href="#offcanvas" class="cb__header-trigger" data-design="<?php echo $design ?>" aria-label="<?php echo $trigger_label ?>" <?php echo rishi__cb_customizer_attr_to_html($attr) ?>>
