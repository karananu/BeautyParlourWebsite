...
$options = array(
	'layouts_postoptions_options' => array(
		'type'               => 'rt-options',
		'setting'            => array( 'transport' => 'postMessage' ),
		'customizer_section' => 'container',
		'inner-options'      => apply_filters( 'rishi__cb_:blog:inneroptions',  array(
			'blog_title_panel' => [
					...
					rishi__cb_customizer_rand_md5() => [
						...
						'options' => [
							'blog_ed_breadcrumbs' => [
								...
								'type'    => 'rara-switch',
								'value'   => $breaddefaults['blog_ed_breadcrumbs'],
							],
							'ed_blog_title' => [
								'label'   => __('Blog Title', 'rishi'),
								'type'    => 'rara-switch',
								'value'   => 'yes',
							],
							'ed_blog_desc' => [
								'label'   => __('Blog Description', 'rishi'),
								'desc'    => __('The blog page content is used as a Blog Description.', 'rishi'),
								'type'    => 'rara-switch',
								'value'   => 'no',
								'divider' => 'top',
							],
			...
			'blog_page_layout'                        => array(
				'label'   => __( 'Blog Page Layout', 'rishi' ),
				'desc'    => __( 'Choose the Blog page layout for your site.', 'rishi' ),
				'type'    => 'rt-image-picker',
				'value'   => $defaults['blog_page_layout'],
				'choices' => array(
					'classic'      => array(
			...
			'archive_blog_post_structure'             => array(
					...
					'excerpt'        => array(
						...
						'options' => array(
							...
							rishi__cb_customizer_rand_md5() => array(
								'type'      => 'rt-condition',
								'condition' => array( 'post_content' => 'excerpt' ),
								'options'   => array(
			...
			'post_navigation'                         => array(
				...
				'type'    => 'rt-select',
				'value'   => $defaults['post_navigation'],
				'view'    => 'text',
				'design'  => 'inline',
				'divider' => 'top',
				'choices' => rishi__cb_customizer_ordered_keys(
			...
			rishi__cb_customizer_rand_md5() => array(
				'type'      => 'rt-condition',
				'condition' => array( 'blog_page_layout' => 'grid | masonry_grid' ),
				'options'   => array(
					'blog_posts_per_row' => array(
						'label'      => __( 'Number of Posts per Row', 'rishi' ),
						'type'       => 'rt-number',
						'design'     => 'inline',
						'value'      => $defaults['blog_posts_per_row'],
						'min'        => 2,
						'max'        => 4,
						'divider'    => 'top',
						'responsive' => false,
			...
			'blog_sidebar_layout'                     => array(
				...
				'type'    => 'rt-image-picker',
				'value'   => $defaults['blog_sidebar_layout'],
				'attr'    => array(
					'data-type'    => 'background',
					'data-usage'   => 'layout-style',
					'data-columns' => '2',
				),
				'desc'    => __( 'Choose sidebar layout for Blog page.', 'rishi' ),
				'divider' => 'top',
				'choices' => array(
			...
			'blog_container'                          => array(
				'label'   => __( 'Blog Container', 'rishi' ),
				'type'    => 'rt-select',
				'value'   => $defaults['blog_container'],
				'view'    => 'text',
				'design'  => 'inline',
				'divider' => 'top',
				'choices' => rishi__cb_customizer_ordered_keys(
				...
				'desc'    => __( 'Choose Blog page container layout.', 'rishi' ),
			),
			'blog_container_streched_ed'              => array(
				'label' => __( 'Stretch Layout', 'rishi' ),
				'desc'  => __( 'This setting stretches the container width.', 'rishi' ),
				'type'  => 'rara-switch',
				// 'sync'    => 'live',
				'value' => $defaults['blog_container_streched_ed'],
			),
		)),
	),
);
